      ...
      <div class="card-body">
         ...
         <form class="forms-sample" action="{{ route('change.password.update') }}" method="POST">
            ...
            <div class="form-group">
               ...
               <input type="password" class="form-control @error('current_password') is-invalid @enderror" id="inputCurrentPassword" name="current_password"
            ...
            <div class="form-group">
               ...
               <input type="password" class="form-control @error('password') is-invalid @enderror" id="inputNewPassword" name="password"
